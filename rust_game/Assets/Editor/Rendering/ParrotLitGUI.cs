...
{
    /// <summary>
    /// Editor script for the Parrot Lit material inspector. Modified from URP default source. 
    /// </summary>
    public static class ParrotLitGUI
    {
        /// <summary>
        ...
        public static class Styles
        {
            ...
            public static GUIContent stencilText = EditorGUIUtility.TrTextContent("Stencil ID", "Here's a tooltip");
        }
        ...
        internal static class Property
        {
            ...
            public static readonly string StencildID = "_StencilID";
        }
        ...
        public static void Inputs(LitProperties properties, MaterialEditor materialEditor, Material material)
        {
            ...
            materialEditor.ShaderProperty(properties.stencilID, Styles.stencilText, 1);
