          ...
          <%= if @current_user.is_admin do %>
            ...
            <div class="bg-white bg-opacity-10 backdrop-blur-sm rounded-xl p-6 hover:bg-opacity-20 transition-all duration-300 transform hover:scale-105">
              <div class="text-center">
                ...
                <h3 class="text-xl font-bold text-white mb-2">World Builder</h3>
                <p class="text-gray-300 mb-4">Build and manage your world</p>
                <.link navigate={~p"/lobby"} class="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-lg transition-colors duration-300">
                  World Builder
                </.link>
              </div>
            </div>
