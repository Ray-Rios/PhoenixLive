...
REM Clean UE5 build artifacts via web container
echo 🎮 Cleaning UE5 build directories...
docker-compose run --rm web bash -c "cd /app && rm -rf rust_game/Build/ rust_game/GameBuild/ rust_game/Packaged/ rust_game/DerivedDataCache/ rust_game/Intermediate/ rust_game/Saved/ 2>/dev/null || true && echo '✅ UE5 build directories cleaned'"
